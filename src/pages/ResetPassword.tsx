...
const ResetPassword: React.FC = () => {
  ...
  const handleUpdate = async () => {
    ...
    setTimeout(() => history.replace('/home'), 2500);
  };
      ...
      <IonContent fullscreen scrollY={false}>
          ...
          <div style={{ width: '100%', maxWidth: 360 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <button
                ...
                disabled={loading || !ready || successToast}
                className="btn-brand"
                style={{
                  width: '100%', padding: '16px 0', borderRadius: 14,
                  fontSize: 16, marginTop: 4,
                  opacity: (!ready || loading || successToast) ? 0.5 : 1,
                  cursor: (!ready || loading || successToast) ? 'not-allowed' : 'pointer',
        ...
        {successToast && (
          <div style={{
            ...
            padding: '14px 24px', borderRadius: 16, zIndex: 100,
            background: 'linear-gradient(135deg,#00F5A0,#00E5FF)',
            boxShadow: '0 0 40px rgba(0,245,160,0.5)',
